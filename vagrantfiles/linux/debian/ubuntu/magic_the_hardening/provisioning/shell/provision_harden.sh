...
#sudo /home/vagrant/custom_scripts/os/install_password_policies.sh # If we don't disable this then the password for vagrant test123... will be blocked apparently
